...
default_template = {
    ...
    "brane_color": GREY,  # Classic red for branes
    "brane_text_color": BLACK,  # White text on branes
    "brane_fill_opa": 0.2,  # Light fill
    "brane_stroke_w": 0.2,  # Thin stroke
    "vacuum_color": DARK_GRAY,  # Red vacuum
    "vacuum_fill_opa": 0.3,  # Light fill
    "vacuum_stroke_w": 0.2,  # Thin stroke
    "vacuum_text_color": BLACK,  # White text in vacuum
    ...
    "string_color": DARK_GREY,  # Blue for strings
    "field_top_color": DARK_GRAY,  # Blue for field tops
}
